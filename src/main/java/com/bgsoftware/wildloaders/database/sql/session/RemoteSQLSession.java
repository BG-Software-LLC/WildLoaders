package com.bgsoftware.wildloaders.database.sql.session;
...
public abstract class RemoteSQLSession implements SQLSession {
    ...
    protected final WildLoadersPlugin plugin;

    @Nullable
    protected HikariDataSource dataSource;
    protected boolean logging;

    protected RemoteSQLSession(WildLoadersPlugin plugin, boolean logging) {
        this.plugin = plugin;
        setLogging(logging);
    }
