...
import com.bgsoftware.wildloaders.logging.Debug;
import com.bgsoftware.wildloaders.logging.Log;
...
public class DBSession {
    ...
    private static SQLDatabaseSession<?> createSessionInternal(WildLoadersPlugin plugin, boolean logging) {
        ...
        switch (database.getType()) {
            case "MYSQL":
                args = new MySQLDatabaseSession.Args(database.getAddress(), database.getPort(), database.getDBName(),
                        ...
                        "WildLoaders Database Thread", LOGGER);
                break;
            case "MARIADB":
