package com.bgsoftware.wildloaders.database.sql;




import com.bgsoftware.wildloaders.WildLoadersPlugin;
import com.bgsoftware.wildloaders.api.data.DatabaseFilter;
import com.bgsoftware.wildloaders.api.objects.Pair;
import com.bgsoftware.wildloaders.database.sql.session.QueryResult;
import com.bgsoftware.wildloaders.database.sql.session.SQLSession;
import com.bgsoftware.wildloaders.database.sql.session.impl.MariaDBSession;
import com.bgsoftware.wildloaders.database.sql.session.impl.MySQLSession;
import com.bgsoftware.wildloaders.database.sql.session.impl.SQLiteSession;
...
public class SQLHelper {
    ...
    public static SQLSession createSession(WildLoadersPlugin plugin, boolean logging) {
    ...
    public static boolean createConnection(WildLoadersPlugin plugin) {
